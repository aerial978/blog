                    ...
                    <form method="post" action="index.php?page=edituser&id=<?= $editUser['id'] ?>" enctype="multipart/form-data">
                        <fieldset class="form-group form-user row g-0">
                            <div class="form-field col-lg-12">
                                ...
                                <input type="text" name="username" id="username" class="form-control" placeholder="At least 8 characters, one lowercase letter, one uppercase letter, one number & one special character like #?!@$%^*-" value="<?= $editUser['username']; ?>">
                            </div>
                            <div class="form-field col-lg-12">
                            ...
                            <div class="form-field col-lg-12 d-flex flex-column mb-3">
                                ...
                                <?php if (!empty($editUser['picture']) && $editUser['picture'] != NULL) : ?>
                                    <img src="../assets/images/<?= $this->issetSession('input','picture') ? $this->getSession('input','picture') : $editUser['picture']; ?>" alt="" width="200px;">
                            ...
                            <div class="form-field col-lg-12">
                                ...
                                <input type="email" class="form-control" name="email" id="email" placeholder="email@address.com" value="<?= $this->issetSession('input','email') ? $this->getSession('input','email') : $editUser['email'] ?>">
                            </div>
                            <div class="form-field col-lg-12">
