                                ...
                                <fieldset class="form-group form-user row g-0">
                                    ...
                                    <div class="form-field col-lg-12">  
                                        ...
                                        <div class="form-field col-lg-12">
                                            ...
                                            <input type="email" class="form-control" name="email" id="email" placeholder="email@address.com" value="<?= isset($_SESSION['input']['email']) ? $_SESSION['input']['email'] : $editUser['email'] ?>">
                                        </div>
                                        <div class="form-field col-lg-12">
