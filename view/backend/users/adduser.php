                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                <fieldset class="form-group form-user row g-0">
                                    ...
                                    <div class="form-field col-lg-12">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control" placeholder="First character uppercase, the rest lowercase" 
                                    ...
                                    <div class="form-field col-lg-12 file-input">
                                        ...
                                        value="<?= $this->issetSession('input','picture') ? $this->getSession('input','picture') : ""; ?>">
                                    </div>
                                    <div class="form-field col-lg-12">
                                        <label for="exampleInputEmail1" class="form-label">Email address</label>
                                        <input type="email" name="email" id="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" 
                                        placeholder="email@address.com" value="<?= $this->issetSession('input','email') ? $this->getSession('input','email') : ""; ?>">
                                    </div>
                                    <div class="form-field col-lg-12">
                                        <label for="inputPassword" class="col-sm-2 col-form-label">Password</label>
                                        <input type="password" name="password" id="password" class="form-control" id="inputPassword" 
                                        placeholder="At least 8 characters, one lowercase letter, one uppercase letter, one number & one special character">
                                    </div>
                                    <div class="form-field col-lg-12">
                                    ...
                                    <?php if ($this->issetSession('auth','role') && $this->getSession('auth','role') == 2): ?>
                                        ...
                                        <?php if(isset($user['role']) && $user['role'] == 2) { "checked='checked'"; } ?> id="checkbox">
