                    ...
                    <form method="post" action="">
                        <fieldset class="form-group form-tag row g-0">
                            <div class="form-field col-lg-12">
                                ...
                                <input type="text" name="tagname" id="tagname" class="form-control" value="<?php $this->issetSession('input','tagname') ? $this->getSession('input','tagname') : ""; ?>">
                            </div>
                            <div class="form-field col-lg-12">
                                <label for="exampleFormControlTextarea1" class="form-label">Description</label>
                                <textarea name="description" id="content" class="form-control"><?php $this->issetSession('input','description') ? $this->getSession('input','description') : ""; ?></textarea>
                            </div>
