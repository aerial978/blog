                        ...
                        <fieldset class="form-group form-post row g-0">                
                            ...
                            <?php if ($this->issetSession('auth','role') && $this->getSession('auth','role') == 2): ?>
                                <div class="form-check">
                                    <input type="checkbox" name="status_post" class="form-check-input mt-3" value="2" <?php if(isset($editPost['status_post']) && $editPost['status_post'] == 2) { echo "checked='checked'"; } ?> id="checkbox">
