                            ...
                            <form method="post" action="">
                                <fieldset class="form-group form-comment row g-0">   
                                    <div class="form-field col-lg-12">
                                        ...
                                        <input type="text" name="name_author" id="name_author" disabled class="form-control" value="<?php $editComment['name_author']; ?>">
                                    </div>
                                    <div class="form-field col-lg-12">
                                        <label for="date_comment">Date</label>
                                        <input type="text" name="date_comment" id="date_comment" disabled class="form-control" value="<?php $editComment['date_comment']; ?>">
                                    </div>
                                    <div class="form-field col-lg-12">
                                        <label for="post_id">Title post</label>
                                        <input type="text" name="post_id" id="post_id" disabled class="form-control" value="<?php $editComment['title']; ?>">
                                    </div>
                                    <div class="form-field col-lg-12">
                                        <label for="" class="form-label">Content</label>
                                        <textarea name="comment" id="comment" class="form-control" readonly id="exampleFormControlTextarea1" rows="5"><?php $editComment['comment']; ?></textarea>
                                    </div>
